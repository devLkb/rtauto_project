...
METRICS = (
    ...
    # 엄지 판정은 2026-08-30에 각도에서 "다른 손끝 대비 깊이"로 바뀌었다
    # (근거는 docs/DG5F_PICKNPLACE.md). 0 이하가 정상.
    ("엄지 깊이", "PicknPlace/ThumbBelowOtherTipsMeters", 100.0, " cm"),
    ("물체 기울기", "PicknPlace/ObjectTiltDegrees", 1.0, " °"),
    ...
    ("커리큘럼 단계", "Environment/Lesson Number/grasp_stage", 1.0, ""),
